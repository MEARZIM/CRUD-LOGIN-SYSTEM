...
const register = () => {
    ...
    const onSignup = async (e:any) => {
        ...
        try {
            ...
            //custom error message for email verification
    ...
    return (
        <div>
            <section >
                <div className="flex flex-col items-center justify-center px-6 py-8 mt-2 mx-auto md:h-screen lg:py-0">
                            ...
                            <form className="space-y-4 md:space-y-6" onSubmit={onSignup}>
                                ...
                                <div>
                                    ...
                                    <input type="confirm-password" name="confirm-password" id="confirm-password" placeholder="••••••••"
                                        ...
                                        ${error ? "dark:border-red-600" : "dark:focus:ring-blue-500 dark:focus:border-blue-500"}`}
